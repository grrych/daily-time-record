...
<div class="max-h-screen w-full flex justify-center items-start py-8 overflow-y-auto scrollbar-thin">
    <div class="shadow-lg bg-white rounded-lg p-8 max-w-md w-full">
        ...
        <!-- Register Form -->
        <form action="<?= e(BASE_URL . '/register.php', false); ?>" method="POST" class="space-y-4">
        ...
        <p class="text-center text-sm text-gray-600 mt-4">
            ...
            <a href="<?= e(BASE_URL . '/login.php', false); ?>" class="text-blue-600 font-medium hover:underline">
                Login here
            </a>
        </p>
